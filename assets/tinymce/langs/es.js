...
tinymce.addI18n('es', {
	...
	'Paste is now in plain text mode. Contents will now be pasted as plain text until you toggle this option off.':
		'Pegar está ahora en modo de texto sin formato. El contenido se pegará ahora como texto sin formato hasta que desactive esta opción.',
	Fonts: 'Fuentes',
	...
	'ID should start with a letter, followed only by letters, numbers, dashes, dots, colons or underscores.':
		'El ID debería comenzar con una letra y seguir solo con letras, números, guiones, puntos, dos puntos o guiones bajos.',
	...
	'Find (if searchreplace plugin activated)':
		'Buscar (si el complemento buscar-reemplazar está activado)',
	...
	'The URL you entered seems to be an email address. Do you want to add the required mailto: prefix?':
		'La URL que ha introducido parece ser una dirección de correo electrónico. ¿Quiere añadir el prefijo necesario mailto:?',
	'The URL you entered seems to be an external link. Do you want to add the required http:// prefix?':
		'La URL que ha introducido parece ser un enlace externo. ¿Quiere añadir el prefijo necesario http://?',
	'The URL you entered seems to be an external link. Do you want to add the required https:// prefix?':
		'La URL que ha introducido parece ser un enlace externo. ¿Quiere añadir el prefijo necesario https://?',
	...
	'Rich Text Area. Press ALT-F9 for menu. Press ALT-F10 for toolbar. Press ALT-0 for help':
		'Área de texto enriquecido. Pulse ALT-F9 para el menú. Pulse ALT-F10 para la barra de herramientas. Pulse ALT-0 para la ayuda.',
