...
tinymce.addI18n('fr', {
	...
	'Paste is now in plain text mode. Contents will now be pasted as plain text until you toggle this option off.':
		"Le collage est maintenant en mode texte brut. Les contenus seront collés sans retenir les formatages jusqu'à ce que vous désactivez cette option.",
	Fonts: 'Polices',
	...
	'ID should start with a letter, followed only by letters, numbers, dashes, dots, colons or underscores.':
		"L'ID doit commencer par une lettre, suivie uniquement par des lettres, numéros, tirets, points, deux-points et underscores.",
	...
	'The URL you entered seems to be an email address. Do you want to add the required mailto: prefix?':
		"L'URL que vous avez saisi semble être une adresse e-mail. Souhaitez-vous y ajouter le préfixe requis mailto: ?",
	'The URL you entered seems to be an external link. Do you want to add the required http:// prefix?':
		"L'URL que vous avez saisi semble être un lien externe. Souhaitez-vous y ajouter le préfixe requis mailto: ?",
