...
tinymce.addI18n('pl', {
	...
	'Paste is now in plain text mode. Contents will now be pasted as plain text until you toggle this option off.':
		'Wklejanie jest w trybie tekstowym. Dopóki nie wyłączysz tej opcji, zawartość będzie wklejana jako zwykły tekst.',
	Fonts: 'Fonty',
	...
	'ID should start with a letter, followed only by letters, numbers, dashes, dots, colons or underscores.':
		'ID powinien zaczynać się literą i składać się tylko z liter, cyfr, myślników, kropek, przecinków oraz znaków podkreślenia.',
