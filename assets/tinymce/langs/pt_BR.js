...
tinymce.addI18n('pt_BR', {
	...
	"Your browser doesn't support direct access to the clipboard. Please use the Ctrl+X/C/V keyboard shortcuts instead.":
		'O seu navegador não suporta acesso direto à área de transferência. Por favor use os atalhos do teclado Ctrl+X/C/V como alternativa.',
	Headings: 'Títulos',
	'Heading 1': 'Título 1',
	'Heading 2': 'Título 2',
	'Heading 3': 'Título 3',
	...
	'Paste is now in plain text mode. Contents will now be pasted as plain text until you toggle this option off.':
		'O comando Colar está no modo de texto simples. O conteúdo será colado como texto simples, até você desligar essa opção.',
	Fonts: 'Fonte',
	...
	'ID should start with a letter, followed only by letters, numbers, dashes, dots, colons or underscores.':
		'O ID deve começar com uma letra, seguida apenas por letras, números, traços, vírgulas ou sublinhas.',
	'You have unsaved changes are you sure you want to navigate away?':
		'Você tem alterações não salvas. Você tem certeza de que deseja sair?',
	...
	'The URL you entered seems to be an email address. Do you want to add the required mailto: prefix?':
		'A URL que você informou parece ser um endereço de e-mail. Deseja adicionar o prefixo obrigatório mailto:?',
	...
	'The URL you entered seems to be an external link. Do you want to add the required https:// prefix?':
		'A URL informada parece ser um link externo. Deseja adicionar o prefixo obrigatório https://?',
	...
	'Rich Text Area. Press ALT-F9 for menu. Press ALT-F10 for toolbar. Press ALT-0 for help':
		'Área de texto rico. Pressione Alt+F9 para exibir o menu, Alt+F10 para exibir a barra de ferramentas ou Alt+0 para exibir a ajuda.',
	...
	'ImageProxy HTTP error: Could not find Image Proxy':
		'Erro de HTTP ImageProxy: não foi possível encontrar o proxy de imagem',
