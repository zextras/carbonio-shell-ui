...
tinymce.addI18n('tr', {
	...
	'ID should start with a letter, followed only by letters, numbers, dashes, dots, colons or underscores.':
		'ID bir harfle başlamalı, ardından yalnızca harf, sayı, tire, nokta, iki nokta üst üste veya alt çizgi gelmelidir.',
	...
	'The URL you entered seems to be an email address. Do you want to add the required mailto: prefix?':
		'Girdiğiniz URL bir e-posta adresi gibi gözüküyor. Gerekli olan mailto: önekini eklemek ister misiniz?',
	...
	'The URL you entered seems to be an external link. Do you want to add the required https:// prefix?':
		'Girdiğiniz URL bir dış bağlantı gibi gözüküyor. Gerekli olan https:// önekini eklemek ister misiniz?',
	...
	'ImageProxy HTTP error: Could not find Image Proxy':
		'ImageProxy HTTP hatası: Görsel Proxy bulunamadı',
	'ImageProxy HTTP error: Incorrect Image Proxy URL':
		"ImageProxy HTTP hatası: Geçersiz Görsel Proxy URL'i",
