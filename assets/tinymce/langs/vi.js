...
tinymce.addI18n('vi', {
	...
	'Paste is now in plain text mode. Contents will now be pasted as plain text until you toggle this option off.':
		'Dán đang trong trạng thái văn bản thuần. Nội dung sẽ được dán dưới dạng văn bản thuần, không định dạng.',
	Fonts: 'Phông chữ',
	...
	'ID should start with a letter, followed only by letters, numbers, dashes, dots, colons or underscores.':
		'ID phải bắt đầu bằng chữ cái, theo sau là các chữ cái, số, dấu gạch ngang, dấu chấm, dấu hai chấm hoặc dấu gạch dưới.',
	...
	'The URL you entered seems to be an external link. Do you want to add the required https:// prefix?':
		'Liên kết bạn nhập có vẻ là liên kết bên ngoài. Bạn có muốn bắt buộc thêm tiền tố https:// ?',
	...
	'ImageProxy HTTP error: Could not find Image Proxy':
		'Lỗi HTTP ImageProxy: Không thể tìm thấy Image Proxy',
	'ImageProxy HTTP error: Incorrect Image Proxy URL':
		'Lỗi HTTP ImageProxy: URL proxy hình ảnh không chính xác',
	'ImageProxy HTTP error: Unknown ImageProxy error':
		'Lỗi HTTP ImageProxy: Lỗi ImageProxy không xác định'
});
