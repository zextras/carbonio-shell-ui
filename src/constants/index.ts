...
export const settingsSubSections = [
	{
		label: 'settings.general.theme_options',
		fallback: 'Theme Options'
	},
	{
		label: 'settings.timezone_and_language',
		fallback: 'Time Zone and Language'
	},
	{
		label: 'settings.out_of_office.headings.settings_label',
		fallback: 'Out of Office Settings'
	},
	{
		label: 'search.app',
		fallback: 'Search'
	...
	{
		label: 'module.app.version',
		fallback: 'Application versions'
	},
	{
		label: 'user_quota.title',
		fallback: "User's quota"
	},
	{
		label: 'settings.general.account',
		fallback: 'Account'
	}
];
