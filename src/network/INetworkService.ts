...
export interface INetworkService {
	...
	registerNotificationParser(tagName: string, parser: INotificationParser<unknown, unknown>): string;
...
export interface INotificationParser<MOD extends {} | unknown, EV_DATA extends {} | unknown> {
