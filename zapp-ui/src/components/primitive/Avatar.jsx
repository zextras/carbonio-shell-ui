...
const AvatarContainer = styled.div`
	...
	background: ${props => props.theme.colors.avatar[props.background]} url(${props => props.picture}) no-repeat;
...
const Capitals = styled.p`
	...
	color: ${props => props.theme.colors.text['txt_3']};
...
Avatar.propTypes = {
	...
	size: PropTypes.oneOf(Object.keys(defaultTheme.sizes.avatar)),
