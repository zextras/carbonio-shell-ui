...
function SvgNewAppointmentOutline(props) {
  return (
    ...
    >
      ...
      />
      <path
        d="M76.8 61.44H66.56V51.2c0-2.809-2.311-5.12-5.12-5.12s-5.12 2.311-5.12 5.12v10.24H46.08c-2.809 0-5.12 2.311-5.12 5.12s2.311 5.12 5.12 5.12h10.24v10.24c0 2.809 2.311 5.12 5.12 5.12s5.12-2.311 5.12-5.12V71.68H76.8c2.809 0 5.12-2.311 5.12-5.12s-2.311-5.12-5.12-5.12z"
        fillRule="nonzero"
      />
    </svg>
  );
