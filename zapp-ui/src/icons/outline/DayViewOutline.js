...
function SvgDayViewOutline(props) {
  return (
    ...
    >
      ...
      <path fill="none" d="M0 0h122.88v122.88H0z" />
      <path
        d="M74.627 112.64H30.72c-8.426 0-15.36-6.934-15.36-15.36V35.84c0-8.426 6.934-15.36 15.36-15.36h5.12v-5.12a5.143 5.143 0 01.335-1.811 5.204 5.204 0 013.512-3.147 5.057 5.057 0 013.2.219c.611.251 1.17.621 1.642 1.082a5.145 5.145 0 011.551 3.657v5.12H76.8v-5.12c0-2.809 2.311-5.12 5.12-5.12s5.12 2.311 5.12 5.12v5.12h5.12c8.426 0 15.36 6.934 15.36 15.36l.08 40.96a5.118 5.118 0 01-1.331 3.43l-27.853 30.72a5.123 5.123 0 01-3.789 1.69zM66.64 102.4V86.272c-.171-7.799 6.077-14.37 13.875-14.592H97.28V35.84c0-2.809-2.311-5.12-5.12-5.12h-5.12v5.12c0 2.809-2.311 5.12-5.12 5.12s-5.12-2.311-5.12-5.12v-5.12H46.08v5.12c0 2.809-2.311 5.12-5.12 5.12s-5.12-2.311-5.12-5.12v-5.12h-5.12c-2.809 0-5.12 2.311-5.12 5.12v61.44c.004.577.098 1.149.291 1.694a5.21 5.21 0 003.194 3.155c.527.18 1.079.267 1.635.271h35.92zm10.24-5.12l14.029-15.36h-10.24a4.061 4.061 0 00-3.789 4.352V97.28z"
        fillRule="nonzero"
      />
    </svg>
  );
