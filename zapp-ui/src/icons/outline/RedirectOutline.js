  ...
  return (
    ...
    >
      ...
      <g clipPath="url(#redirect-outline_svg__a)">
        ...
        <g>
          <path
            d="M106.43 42.566l-20.48-25.6a5.119 5.119 0 00-3.723-1.606c-2.809 0-5.12 2.311-5.12 5.12a5.12 5.12 0 00.856 2.834L91.787 40.62h-30.55c-8.427 0-15.36 6.934-15.36 15.36v26.56c0 2.809 2.311 5.12 5.12 5.12 2.808 0 5.12-2.311 5.12-5.12V55.98c0-2.809 2.311-5.12 5.12-5.12h30.55L77.963 68.166c-1.731 2.194-1.362 5.421.819 7.168a5.128 5.128 0 003.175 1.126 5.12 5.12 0 003.993-1.946l20.48-25.6a5.131 5.131 0 000-6.348z"
            fillRule="nonzero"
          />
        </g>
      </g>
