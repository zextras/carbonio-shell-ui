  ...
  return (
    ...
    >
      ...
      <path
        ...
        fillRule="nonzero"
      />
      <path d="M84.469 56.289c0-2.826-2.294-5.12-5.12-5.12s-5.12 2.294-5.12 5.12V87.04c0 2.826 2.294 5.12 5.12 5.12s5.12-2.294 5.12-5.12V56.289zM48.651 56.289c0-2.826-2.294-5.12-5.12-5.12s-5.12 2.294-5.12 5.12V87.04c0 2.826 2.294 5.12 5.12 5.12s5.12-2.294 5.12-5.12V56.289zM66.56 56.289c0-2.826-2.294-5.12-5.12-5.12s-5.12 2.294-5.12 5.12V87.04c0 2.826 2.294 5.12 5.12 5.12s5.12-2.294 5.12-5.12V56.289z" />
    </svg>
  );
}
